...
def extrair_vagas(assunto: str, remetente: str, corpo: str) -> list[dict]:
    """
    ...
    Retorna lista de dicts. Cada dict tem a estrutura:
    {
      "cargo":                 str,
      "empresa":               str | null,
      "local":                 str | null,
      ...
      "link_candidatura":      str | null,
      "tipo_email":            "candidatura_enviada | nova_vaga | retorno | avanco_fase | outro",
      "status_candidatura":    "enviada | visualizada | avanco | reprovado | nova" | null,
    }
...
IMPORTANTE:
- Se for um digest (Catho, Indeed, LinkedIn com múltiplas vagas), extraia cada vaga individualmente.
- Se for "sua candidatura foi enviada", crie 1 item com tipo_email = "candidatura_enviada".
- Se for "você avançou de fase", crie 1 item com tipo_email = "avanco_fase".
- Se for "retorno do processo seletivo", crie 1 item com tipo_email = "retorno".
- score_match: 0-100 baseado em Python, automação, dados, IA, APIs. Vagas sem tech → score 30.
- link_candidatura: extraia o URL mais relevante para candidatar-se (não o unsubscribe).
...
[
  {{
    ...
    "modelo_trabalho": "Remoto | Híbrido | Presencial | Não informado",
    "salario": "string com valor ou null",
    "requisitos": ["lista de requisitos ou []"],
    "tecnologias": ["lista de techs ou []"],
    "score_match": 0,
    "link_candidatura": "URL ou null",
    "tipo_email": "candidatura_enviada | nova_vaga | retorno | avanco_fase | outro",
